...
void SceneExit_Init(Actor* thisx, GlobalContext* globalCtx);
void SceneExit_Destroy(Actor* thisx, GlobalContext* globalCtx);
void SceneExit_Update(Actor* thisx, GlobalContext* globalCtx);
void SceneExit_Draw(Actor* thisx, GlobalContext* globalCtx);
...
void SceneExit_Draw(Actor* thisx, GlobalContext* globalCtx) {
    if (globalCtx->state.gfxCtx->unk_014 == 0) {
    ...
    for (int i = 0; i < this->polyCount; i++) {
        for (int v = 0; v < 3; v++) {
            ...
            Collider_DrawPoly(globalCtx->state.gfxCtx, &vecA, &vecB, &vecC, 255, 0, 0);
